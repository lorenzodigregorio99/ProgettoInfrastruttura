...
* **Routing and Remote Access (RRAS):** Configurazione dei servizi di routing e di acesso remoto per l'instradamento inter-network del traffico dati.
...
* **Sistemi Operativi:** Windows Server 2012, Windows 7.
